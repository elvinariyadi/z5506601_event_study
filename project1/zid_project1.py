...
#    Please put your answers for the last question here:
    """
    Step 1 is configured for portability, making sure the code can be run on different computers. While using dynamic
    paths to ensure maintainability as it is easier to update or restructure project. 
    
    Investors evaluation of those firms means journalist cover investors evaluation and analysis. Writing a negative 
    article about it means journalist found investors have a negative view towards this certain stock. The constant
    decrement could be the sign that investors evaluation is in line with the market reaction.
    
    Valuable information beyond firm fundamentals suggests journalist possess valuable information that is not reflected
    on company's fundamental. In this case, the constant stock return decrement reflects the market reaction towards 
    journalist information that led them to reevaluate their evaluation towards the firm, Which affects their long-term 
    view, thus theres no reversal in the long run. 
    
    Hypothesis 2: Valuable information beyond firm fundamentals seems more likely. Since persistent impact on stock return 
    suggest that the disclosed information leads to a fundamental and lasting reevaluation fundamental value. While if 
    its investor evaluation, the market reaction would fades over time ans fundamentals take over. 
    
    This leads to an increase in trading volume for the net day, as investors adjust their position after information asymmetry. 
    abd market reaction as people are buying and selling after the sentiment. 
    """
# ----------------------------------------------------------------------------
